...
export default function Page() {
  return (
    <main>
        ...
        <p className="mb-8">昔からガジェット関連は好きで、今度自作キーボードに挑戦してみようと企んでいます。趣味としてエレキギターと自然言語学習（もちろんプログラミング言語も！）を楽しんでいます。言語学習は英語を中心に勉強してきましたが、最近は韓国語の勉強にもチャレンジしています。マイブームは少し前に買った一眼レフです。</p>
    </main>
  )
}