...
import profilePic from '../../../src/public/profile_pic.png';
...
export const Page = () => {
  return (
    <main>
        ...
        <p className="text-center text-xs text-gray-400 pb-2">エンジニア志望の学生</p>
        ...
        <h2 className="text-3xl font-semibold border-b-2 pb-1 mb-4">Skill</h2>
        <h3 className="text-2xl font-semibold mb-3">よく使う技術</h3>
        <ul className="list-disc mb-6">
            <li className="ml-5 mb-2">HTML/CSS(Tailwind CSS)</li>
            <li className="ml-5 mb-2">JavaScript, TypeScript(Vue, React, Next.js)</li>
            <li className="ml-5 mb-2">C++</li>
            <li className="ml-5 mb-2">Unity</li>
            <li className="ml-5 mb-2">Git/GitHub</li>
        </ul>
        <h3 className="text-2xl font-semibold mb-3">その他勉強中の技術</h3>
        <ul className="list-disc mb-6">
        ...
        <h3 className="text-2xl font-semibold mb-3">資格</h3>
        <ul className="list-disc mb-6">
        ...
        <h2 className="text-3xl font-semibold border-b-2 pb-1 mb-4">Career</h2>
        <ul className="list-disc mb-6">
            <li className="ml-5 mb-2">青山学院大学 社会情報学部入学 (2021.4)</li>
            <li className="ml-5 mb-2">英語学習スタート(2022.1)</li>
            <li className="ml-5 mb-2">ゼミ配属・株式会社ハウコレにてVueフロントエンドエンジニアとして長期インターン開始(2023.4)</li>
            <li className="ml-5 mb-2">DMM Group、Sansan株式会社にて短期インターン参加(2023.8)</li>
            <li className="ml-5 mb-2">カナダ・トロントのヨーク大学へ8ヶ月の交換留学(2023.8 - 2024.4)</li>
        </ul>

        <h2 className="text-3xl font-semibold border-b-2 pb-1 mb-4">好きなこと</h2>
        <p className="mb-8">昔からガジェット関連は好きで、今度自作キーボードに挑戦してみようと企んでいます。趣味としてエレキギターと自然言語学習（もちろんプログラミング言語も！）を楽しんでいます。言語学習は英語を中心に勉強してきましたが、最近は韓国語の勉強にもチャレンジしています。現在のマイブームは少し前に買った一眼レフです。</p>
    </main>
  )
}
